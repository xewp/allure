...
const Footer = () => {
  return (
    <footer className="w-full py-16 mt-20 bg-gradient-to-b from-charcoal to-black border-t border-gold/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 text-center md:text-left">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-sm mx-auto md:mx-0">
              ...
              Your trusted partner for premium talent.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="w-10 h-10 rounded-full bg-warm-gray/80 border border-gold/20 flex items-center justify-center hover:bg-gold hover:border-gold transition-all duration-300 hover:scale-110 group"
            >
              <svg
